...
public final class CameraManager {
    ...
    public synchronized void startPreview() {
        ...
        if (theCamera != null && !previewing) {
            ...
            previewing = true;
            autoFocusManager = new AutoFocusManager(configManager, theCamera.getCamera());
        }
    }
    ...
    /**
     * Convenience method for 二维码 Activity
     *
    ...
    public synchronized Rect getFramingRectInPreview() {
        if (framingRectInPreview == null) {
            ...
            int realCameraX, realCameraY;
            if (configManager.getCWNeededRotation() == 0) {
                realCameraX = cameraResolution.x;
                realCameraY = cameraResolution.y;
            } else {
                realCameraX = cameraResolution.y;
                realCameraY = cameraResolution.x;
            }
            ...
            rect.left = rect.left * realCameraX / screenResolution.x;
            rect.right = rect.right * realCameraX  / screenResolution.x;
            rect.top = rect.top * realCameraY/ screenResolution.y;
            rect.bottom = rect.bottom * realCameraY / screenResolution.y;
